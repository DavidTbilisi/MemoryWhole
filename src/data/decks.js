export const DECKS = [
  ...
  { deck: 'pao10people', name: 'PAO10 — People', count: '10 persons · 3-digit encoding', icon: '🧑' },
  { deck: 'pao10actions', name: 'PAO10 — Actions', count: '10 actions · 3-digit encoding', icon: '⚡' },
  { deck: 'pao10objects', name: 'PAO10 — Objects', count: '10 objects · 3-digit encoding', icon: '🗡️' },
